...
export default function BlogHero() {
  return (
    <div className=" bg-gray-50">
      <section
        style={{
          backgroundImage: `url('/images/Group 3462.svg')`,
          backgroundRepeat: "no-repeat",
          backgroundSize: "65%",
          backgroundPosition: "center",
        }}
        className="Blog-hero-bg dark:bg-gray-900 p-4"
      >
        <nav className=" py-4  pf">
          <div className="container-1 flex flex-wrap items-center justify-between mx-auto">
            ...
            <div>
              <button
                type="button"
                className=" hover:bg-orange-500 text-white font-bold py-2 px-4 rounded mr-6"
              >
                Help
              </button>
        ...
        <div className="container px-6 py-16 mx-auto text-center">
          <div className=" w-full mx-auto">
            {/* <h1 className="text-3xl font-semibold text-blue-900 dark:text-white lg:text-4xl">
              BUILD GREAT TECH TEAMS FASTER WITH CLIQIN
            </h1> */}
            <p className="mt-6 text-white font-bold dark:text-gray-300">
              How can we help you?
            </p>
            <div className="w-full max-w-xl mx-auto mt-6 bg-transparent border rounded-md dark:border-gray-700 focus-within:border-orange-500 focus-within:ring focus-within:ring-orange-500 dark:focus-within:border-orange-600 focus-within:ring-opacity-40">
              <form className="flex flex-col md:flex-row bg-white rounded-xl p-1">
                <input
                  type="email"
                  placeholder="enter "
                ...
                <button
                  type="button"
                  className="h-10 px-4 py-2 m-1 text-white transition-colors duration-300 transform bg-orange rounded-md hover:bg-orange-400 focus:outline-none focus:bg-orange-500"
                >
                  Search
                </button>
              </form>
      ...
      <section className="overflow-hidden bg-white sm:grid sm:grid-cols-2 lg:mx-8 sm:mx-0 mt-8 rounded-xl p-8">
        <img
          alt="Student"
        ...
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center sm:text-left">
            <h2 className="text-2xl font-bold cliqin-blue-text md:text-3xl">
              The unlimate guide to high-Potential identification
            </h2>
            ...
            <div className="mt-4 md:mt-8">
              <button
                type="button"
                className="bg-button hover:bg-orange-500 hover:text-white font-bold py-2 px-4 rounded mr-6"
              >
                Read more
              </button>
            </div>
      ...
      <section className="overflow-hidden bg-white dark:text-gray-100 p-8 rounded-xl lg:mx-8 sm:mx-0 mb-8">
        <div className="container  p-6 mx-auto space-y-6 sm:space-y-12">
          <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl ">
              <img
                alt="Office"
                src="/images/1.png"
              ...
              <div className="p-4 sm:p-6">
                <a href="#">
                  <h3 className="text-lg font-medium cliqin-blue-text">
                    Successful succession planning in 2022(the ultimate guide)
                  </h3>
                  <img src="/images/Path 5303.svg" alt="" />
                </a>
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Finding a rightful successor for business continuity has been
                  an ongoing part of humankind's existence.
                </p>
              </div>
            </article>
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
              ...
              <div className="p-4 sm:p-6">
                <a href="#">
                  <h3 className="text-lg font-medium cliqin-blue-text">
                    The ultimate guide to clickHR
                  </h3>
                  <img src="/images/Path 5303.svg" alt="" />
                </a>
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Closely following the facebooks & microsofts of the world,
                  more and more tech companies are turning to cliqHR, some to
                  propel their brand , other to hire at speed.
                </p>
              </div>
            </article>
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
              <img
                alt="Office"
                src="/images/NoPath - Copy (4).png"
                className=" h-72 w-full object-cover"
              />
              <div className="p-4 sm:p-6">
                <a href="#">
                  <h3 className="text-lg font-medium cliqin-blue-text">
                    What is an online assessment? here everything you need to
                    know
                  </h3>
                  <img src="/images/Path 5303.svg" alt="" />
                </a>
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Assessment and how to leverage such assessment tests to make
                  successful recruiting decisions.
                </p>
              </div>
            </article>
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
              <img
                alt="Office"
                src="/images/NoPath - Copy (5).png"
                className=" h-72 w-full object-cover"
              />
              <div className="p-4 sm:p-6">
                <a href="#">
                  <h3 className="text-lg font-medium cliqin-blue-text">
                    6 Strategies to give your employees the work experience they
                    deserve
                  </h3>
                  <img src="/images/Path 5303.svg" alt="" />
                </a>
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Many business are still unware of what employees want from
            ...
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
              <img
                alt="Office"
                src="/images/pexels-photo-5408914.png"
                className=" h-72 w-full object-cover"
              />
              <div className="p-4 sm:p-6">
                <a href="#">
                ...
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Businesses are putting in a lot of effort to develop DE&I
                  programs in their workplaces so that their employees can be
                  seen and heard.
                </p>
              </div>
            </article>
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
              <img
                alt="Office"
                src="/images/NoPath - Copy (7).png"
                className=" h-72 w-full object-cover"
              />
              <div className="p-4 sm:p-6">
                <a href="#">
                  <h3 className="text-lg font-medium cliqin-blue-text">
                    Transform your workplace essential
                  </h3>
                  <img src="/images/Path 5303.svg" alt="" />
                </a>
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Learner can choose the delivery methods that best suit their
                  goals, hybrid learning programs provide a high return on
                  investment (ROI)
                </p>
              </div>
            </article>
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
              ...
              <div className="p-4 sm:p-6">
                ...
                <p className="mt-2 text-sm leading-relaxed text-gray-500 line-clamp-3">
                  Lorem ipsum dolor sit amet, Recusandae dolores, possimus
                  pariatur animi temporibus
                </p>
              </div>
            </article>
            <article className="overflow-hidden rounded-2xl border border-gray-100 shadow-2xl">
